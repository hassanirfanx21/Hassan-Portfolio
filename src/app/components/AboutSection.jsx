      ...
      <div className="rounded-md flex flex-col md:grid md:grid-cols-2 gap-8 md:gap-8 items-start py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 space-y-8 md:space-y-0 relative z-10">
        ...
        >
          ...
          <p className="text-base lg:text-lg">
            I am a software engineer currently studying at the National University of Sciences and Technology (NUST), with a strong passion for full-stack development. I specialize in building scalable and efficient applications using technologies such as React, Node.js, and SQL. My experience spans from creating dynamic user interfaces to integrating backend systems and optimizing database performance. I am constantly learning and applying new techniques to enhance my skill set and contribute to impactful projects. In addition, I have experience in designing seamless user experiences and am dedicated to delivering high-quality code that meets both user needs and business objectives.
          </p>
          ...
          {/* TAB CONTENT */}
          <div className="mt-8 h-[300px] overflow-y-auto p-4 rounded-md">
